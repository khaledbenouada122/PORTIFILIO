...
function ExperienceComponent({experiences}: Props) {
  return (
    ...
    <div className='mt-10 md:mt-8 w-full flex space-x-5 overflow-x-scroll snap-x snap-mandatory scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/40'>
